...
public class GameOverScreen implements Screen {
	...
	public void render (float delta) {
		...
		game.batch.draw(gameOverBanner, NinjaFruitGame.WIDTH / 2 - BANNER_WIDTH / 2, NinjaFruitGame.HEIGHT - BANNER_HEIGHT - 15, BANNER_WIDTH, BANNER_HEIGHT);

		GlyphLayout scoreLayout = new GlyphLayout(scoreFont, "Score: \n" + score, Color.WHITE, 0, Align.left, false);
		GlyphLayout highscoreLayout = new GlyphLayout(scoreFont, "Highscore: \n" + highscore, Color.WHITE, 0, Align.left, false);
		scoreFont.draw(game.batch, scoreLayout, NinjaFruitGame.WIDTH / 2 - scoreLayout.width / 2, NinjaFruitGame.HEIGHT - BANNER_HEIGHT - 15 * 2);
		scoreFont.draw(game.batch, highscoreLayout, NinjaFruitGame.WIDTH / 2 - highscoreLayout.width / 2, NinjaFruitGame.HEIGHT - BANNER_HEIGHT - scoreLayout.height - 15 * 3);
		...
		float tryAgainY = NinjaFruitGame.HEIGHT / 2 - tryAgainLayout.height / 2;
		float mainMenuX = NinjaFruitGame.WIDTH / 2 - mainMenuLayout.width /2;
		float mainMenuY = NinjaFruitGame.HEIGHT / 2 - mainMenuLayout.height / 2 - tryAgainLayout.height - 15;
