...
public class ScrollingBackground {
	...
	public ScrollingBackground () {
		...
		imageScale = NinjaFruitGame.WIDTH / image.getWidth();
		speedFixed = true;
	}
	...
	public void updateAndRender (float deltaTime, SpriteBatch batch) {
		...
		//Render
		batch.draw(image, 0, y1, NinjaFruitGame.WIDTH, image.getHeight() * imageScale);
		batch.draw(image, 0, y2, NinjaFruitGame.WIDTH, image.getHeight() * imageScale);
	}
